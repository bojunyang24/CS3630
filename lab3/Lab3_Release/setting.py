...
# if True:
#     ODOM_TRANS_SIGMA = 0.001     # translational err in inch (grid unit)
#     ODOM_HEAD_SIGMA = 0.01       # rotational err in deg
#     MARKER_TRANS_SIGMA = 0.001    # translational err in inch (grid unit)
#     MARKER_ROT_SIGMA = 0.01        # rotational err in deg
